...
/**
 * Chuncker class used to split a byte array into chunks of a specified size.
 *
 * @author John Doe
 */
public class Chuncker {
    ...
    /**
     * Constructs a new Chuncker object with the given data and a default chunk size of 1024.
     *
     * @param data The data to be chunked.
     */
    public Chuncker(byte[] data) {
        this(data, 1024);
    }

    /**
     * Constructor for Chuncker class.
     *
     * @param data      The data to be chunked.
     * @param chunkSize The size of each chunk.
     */
    public Chuncker(byte[] data, int chunkSize) {
        this.data = data;
