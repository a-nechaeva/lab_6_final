...
public enum CommandType implements Serializable {
 ...
 //   REMOVE_ALL_BY_MPAA_RATING(RemoveByMpaaRatingCommand.class, "remove_all_by_mpaa_rating <mpaaRating>: remove from the collection all elements whose mpaaRating field value is equivalent to the specified one"),
